...
function Initialize()
{
  ...
  viewMatrix = makeYRotation(0 * (90*3.14/180));
  //makeModel('cube1', 0, 0, 0, 0.2, 0.2, 0.2, 'cube.data')
  makeModel('fish1', 0, 0, 0, 0.07, 0.07, 0.07, 'fish1.txt')
makeModel('fish2', 4, 5, 6, 0.15, 0.15, 0.15, 'fish2.txt')
makeModel('fish3', 4, 4, 6, 0.07, 0.07, 0.07, 'fish1.txt')
makeModel('fish4', -4, 2, 6, 0.15, 0.15, 0.15, 'fish2.txt')
makeModel('shark', -4, 4, 5, 0.15, 0.15, 0.15, 'shark.obj')
makeModel('grass', 0.0, -2.0, -3, 0.3, 0.25, 0.25, 'grass.obj')
...
function drawScene(){
gl.clearColor(0, 153/255, 255/255, 1.0);
...
if (filename=='fish1.txt'){
            r1=150; g1=50; b1=200;
            r2=50; g2=150; b2=100;
            r3=250; g3=50; b3=100;
          }          
else if (filename=='grass.obj'){
	r1=0; g1=200; b1=00;
            r2=0; g2=250; b2=00;
            r3=0; g3=150; b3=00;
          } 
	else if(filename=='fish2.txt'){
	r1 = 100;
          r2=100;
          r3=30;
}
else if(filename=='shark.obj')
{
r1=50; g1=50; b1=100;
            r2=50; g2=50; b2=150;
            r3=50; g3=50; b3=100;
